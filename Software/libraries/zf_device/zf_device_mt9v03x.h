...
// 引脚配置
//--------------------------------------------------------------------------------------------------
#define MT9V03X_COF_UART        (UART_4     )                                   // 配置摄像头所使用到的串口
#define MT9V03X_COF_BAUR        (9600       )                                   // 总钻风配置串口波特率
#define MT9V03X_COF_UART_TX     (UART4_RX_C17)                                  // 总钻风 UART-TX 引脚 要接在单片机 RX 上
#define MT9V03X_COF_UART_RX     (UART4_TX_C16)                                  // 总钻风 UART-RX 引脚 要接在单片机 TX 上

#define MT9V03X_COF_IIC_DELAY   (800)                                           // 总钻风 IIC 延时
#define MT9V03X_COF_IIC_SCL     (C17)                                           // 总钻风 IIC-SCL 引脚
#define MT9V03X_COF_IIC_SDA     (C16)                                           // 总钻风 IIC-SDA 引脚

#define MT9V03X_PCLK_PIN        (CSI_PIXCLK_B20)                                // PCLK 触发信号 TIM_ETR 引脚禁止随意修改
#define MT9V03X_VSYNC_PIN       (CSI_VSYNC_B14)                                 // 场中断引脚
...
#define MT9V03X_EXP_TIME_DEF    (128)                                           // 曝光时间         摄像头收到后会自动计算出最大曝光时间，如果设置过大则设置为计算出来的最大曝光值
