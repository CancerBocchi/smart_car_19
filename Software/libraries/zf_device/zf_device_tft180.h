...
#define TFT180_SCL_PIN                  (B0)                                    // 软件 SPI SCK 引脚
#define TFT180_SDA_PIN                  (B1)                                    // 软件 SPI MOSI 引脚
//====================================================软件 SPI 驱动====================================================
#else
//====================================================硬件 SPI 驱动====================================================
#define TFT180_SPI_SPEED                (40 * 1000 * 1000)                      // 硬件 SPI 速率
#define TFT180_SPI                      (SPI_3)                                 // 硬件 SPI 号
#define TFT180_SCL_PIN                  (SPI3_SCK_B0 )                          // 硬件 SPI SCK 引脚
#define TFT180_SDA_PIN                  (SPI3_MOSI_B1)                          // 硬件 SPI MOSI 引脚
//====================================================硬件 SPI 驱动====================================================
#endif

#define TFT180_RES_PIN                  (C24)                                   // 液晶复位引脚定义
#define TFT180_DC_PIN                   (C26)                                   // 液晶命令位引脚定义
#define TFT180_CS_PIN                   (B3 )                                   // CS 片选引脚
#define TFT180_BL_PIN                   (C25)                                   // 液晶背光引脚定义
