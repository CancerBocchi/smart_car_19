...
#define WIFI_SPI_MISO_PIN           (SPI3_MISO_B2)             // 定义SPI_MISO引脚  IPS没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
#define WIFI_SPI_CS_PIN             (B3)                       // 定义SPI_CS引脚 采用软件CS引脚
#define WIFI_SPI_INT_PIN            (C25)                       // 定义中断引脚
#define WIFI_SPI_RST_PIN            (C24)                       // 定义复位引脚
