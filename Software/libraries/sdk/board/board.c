...
void example_uart1_callback(LPUART_Type *base, lpuart_handle_t *handle, status_t status, void *userData)
{
    ...
    {
        rt_mb_send(uart_mb, example_rx_buffer);       
    }
...
void board_init(void)
{
        ...
        uart_set_handle(DEBUG_UART_INDEX, &example_g_lpuartHandle, example_uart1_callback, NULL, 0, example_receivexfer.data, 1);
        
        NVIC_SetPriority(LPUART1_IRQn, 14);          
